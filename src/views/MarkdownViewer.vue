<template>
  <div class="markdown-viewer">
    <div class="markdown-viewer-content">
      <a id="donwload-doc-src" v-if="docURL" :href="docURL" target="_blank">查看源文档（Markdown）</a>
...
export default {
  ...
  computed: {
    BASE_MARKDOWN_URL() {
      return 'https://zhuyun-static-files-production.oss-cn-hangzhou.aliyuncs.com/dataflux-func/resource/';
    },
  },
  data() {
    return {
