<template>
  <div class="header">
    ...
    <div id="nav">
      ...
      | <router-link :to="{ name: 'MarkdownViewer', query: { q: 'maintenance-guide.md' }}">维护手册</router-link>
      | <router-link :to="{ name: 'MarkdownViewer', query: { q: 'development-guide.md' }}">开发手册</router-link>
    </div>
  </div>
</template>
